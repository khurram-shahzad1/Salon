                    ...
                    <div class="row">
                        <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                            <div class="mb-30"> <img src="images/services/1.jpg" class="img-fluid mb-30" alt="">
                                <h3>Facial </h3>
                                <p>We can provide these kinds of facial</p> 
                                    
                                    <ul >
                                            <li><a >Gold Facial</a></li>
                                            <li><a >Fruit Facial</a></li>
                                            <li><a >Acne Reduction Facial</a></li>
                                            </ul>
                            ...
                            <div class="betty-sidebar-part">
                                <div class="betty-sidebar-block betty-sidebar-block-categories">
                                    ...
                                    <div class="betty-sidebar-block-content">
                                        ...
                                        <h5 class="title">Gold Facial <span class="price">$27,00</span></h5>
                                        <p> We can provide you best fecisl treatment</p>
                                    </div>
                                     <div class="services-price-info">
                                        <h5 class="title">Fruite Facial <span class="price">$30,00</span></h5>
                                        <p>We can provide you the best fecial here</p>
                                    </div>
                                     <div class="services-price-info">
                                        <h5 class="title">Acne reduction Facial <span class="price">$40,00</span></h5>
                                        <p>We can provide you the best Facial  here</p>
                                    </div>
                                    </div>
                                </div>
                            </div>
