    ...
    <div id="betty-page"> <a href="#" class="js-betty-nav-toggle betty-nav-toggle"><i></i></a>
        ...
        <aside id="betty-aside">
            ...
            <div>
                ...
                <h2>Salon<span>Managment System</span></h2> </div>
            <!-- Menu -->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                            <div class="mb-30"> <img src="images/services/01.jpg" class="img-fluid mb-30" alt="">
                                <h3>Face Makeup </h3>
                                <p>We can provide Following services of face Makeup</p> 
                                    <ul >
                                            <li><a >Bridel Makeup</a></li>
                                            <li><a >Regular Makeup</a></li>
                                            <li><a >Party  Makeup</a></li>
                                            </ul>
                            ...
                            <div class="betty-sidebar-part">
                                <div class="betty-sidebar-block betty-sidebar-block-categories">
                                    ...
                                    <div class="betty-sidebar-block-content">
                                        ...
                                        <h5 class="title">Bridel Makeup<span class="price">$50,00</span></h5>
                                        <p>we can provide the best Bridel Makeup here.</p>
                                    </div>
                                     <div class="services-price-info">
                                        <h5 class="title">Reguler Makeup<span class="price">$27,00</span></h5>
                                        <p>We can provide the best makeup services here.</p>
                                    </div>
                                     <div class="services-price-info">
                                        <h5 class="title">Party Makeup<span class="price">$30,00</span></h5>
                                        <p>We can provide the best Party Makeup here.</p>
                                    </div>
                                    </div>
                                </div>
                            </div>
