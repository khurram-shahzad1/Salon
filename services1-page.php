                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                            <div class="mb-30"> <img src="images/services/123.jpg" class="img-fluid mb-30" alt="">
                                <h3>Eye Makeup</h3>
                                <p>We can provide these kinds of Eye Makeup</p> 
                                <ul >
                                            <li><a >Smokey Eye Makeup</a></li>
                                            <li><a >Party Eye Makeup</a></li>
                            ...
                            <div class="betty-sidebar-part">
                                <div class="betty-sidebar-block betty-sidebar-block-categories">
                                    ...
                                    <div class="betty-sidebar-block-content">
                                        ...
                                        <h5 class="title">Smokey Eye Makeup <span class="price">$27,00</span></h5>
                                        <p>We can provide the best  Eye Makeup here.</p>
                                    </div>
                                     <div class="services-price-info">
                                        <h5 class="title">Party Eye Makeup <span class="price">$30,00</span></h5>
                                        <p>We can provide the best Eye Makeup here.</p>
                                    </div>
                                     <div class="services-price-info">
                                        <h5 class="title">Bridel Eye Makeup <span class="price">$40,00</span></h5>
                                        <p>We can provde the best Eye Makeup here.</p>
                                    </div>
                                    </div>
                                </div>
                            </div>
