                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                            <div class="mb-30"> <img src="images/services/2.jpg" class="img-fluid mb-30" alt="">
                                <h3>Skin Polish </h3>
                                <p>We can provide the best services of Skin Polish .If you can viste us you must be setisfied</p> 
                            ...
                            <div class="betty-sidebar-part">
                                <div class="betty-sidebar-block betty-sidebar-block-categories">
                                    ...
                                    <div class="betty-sidebar-block-content">
                                        ...
                                        <h5 class="title">Skin Polish <span class="price">$20,00</span></h5>
                                        <p>We can provide best Skin Polish services here.</p>
                                    </div>
                                    </div>
                                </div>
                            </div>
